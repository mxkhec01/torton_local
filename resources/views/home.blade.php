            ...
            <div class="card-header">
              ...
              <div class="card-tools">
                <ul class="nav nav-pills ml-auto">
                  <li class="nav-item">
                    <a class="nav-link active" href="{{ asset('#revenue-chart') }}" data-toggle="tab">Area</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{ asset('#sales-chart') }}" data-toggle="tab">Donut</a>
                  </li>
                </ul>
              </div>
            </div><!-- /.card-header -->
            ...
            <div class="card-header">
              ...
              <div class="card-tools">
                <ul class="pagination pagination-sm">
                  <li class="page-item"><a href="{{ asset('#') }}" class="page-link">&laquo;</a></li>
                  <li class="page-item"><a href="{{ asset('#') }}" class="page-link">1</a></li>
                  <li class="page-item"><a href="{{ asset('#') }}" class="page-link">2</a></li>
                  <li class="page-item"><a href="{{ asset('#') }}" class="page-link">3</a></li>
                  <li class="page-item"><a href="{{ asset('#') }}" class="page-link">&raquo;</a></li>
                </ul>
              </div>
            </div>
            <!-- /.card-header -->
